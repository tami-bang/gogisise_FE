...
export function AuthBottomSheet({ isOpen, onClose }: Props) {
  ...
  return createPortal(
    <>
      ...
      {/* 💡 [한글 주석] 가로/세로 정렬 꼬임을 방지하기 위한 flex 정렬 wrapper 구현 */}
      <div className="fixed inset-0 z-[100] flex items-end justify-center pointer-events-none">
        {/* Bottom Sheet 카드 본체 */}
        <div 
          className="relative w-full max-w-md h-[calc(100dvh-72px)] bg-[var(--color-bg)] rounded-t-2xl shadow-[0_-4px_24px_rgba(0,0,0,0.08)] pointer-events-auto animate-slide-up flex flex-col"
          role="dialog"
          aria-modal="true"
