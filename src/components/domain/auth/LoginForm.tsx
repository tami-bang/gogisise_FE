  ...
  return (
    <form onSubmit={handleSubmit} className="flex flex-col gap-5">
      ...
      <div className="flex flex-col items-center justify-center pt-2 pb-6 gap-2">
        <div className="w-20 h-20 bg-[var(--color-primary)] rounded-[var(--radius-xl)] flex items-center justify-center text-white mb-2 shadow-sm">
        ...
        <h3 className="text-title-lg font-bold text-[var(--color-primary)]">도매 시세</h3>
        <p className="text-sm text-[var(--text-muted)] text-center">베테랑 사장님을 위한 실시간 고기 시세 서비스</p>
      </div>
      ...
      <div className="mt-6 mb-2">
        ...
        <div className="flex gap-3">
          <button
            ...
            className="flex-1 h-12 bg-[#FEE500] text-[#000000] rounded-[var(--radius-md)] flex items-center justify-center font-bold text-sm active:scale-95 transition-transform shadow-sm"
          >
